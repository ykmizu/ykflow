...
void *yk_createSnapshotResidual(){
  //This will run through all the reduced order model routines to print out the
  //the residuals that we want. They will all be printed out to a
}
